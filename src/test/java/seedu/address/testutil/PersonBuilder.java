...
public class PersonBuilder {
     ...
     *
     * @param personToCopy The person whose details are to be copied.
     */
     ...
     *
     * @param tags The tags to be added to the person.
     * @return The updated {@code PersonBuilder} object.
     */
     ...
     *
     * @return A {@code Person} object with the specified details.
     */
    public Person build() {
